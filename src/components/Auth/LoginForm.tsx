      ...
      <div className="glass-effect rounded-3xl p-8 md:p-10 card-shadow animate-scaleIn border border-amber-200/30 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-700 font-serif italic mb-2">
            "Return to the sweetness you love"
          </p>
        ...
        <div className="mt-8 pt-6 border-t border-amber-200/50 text-center animate-fadeInUp" style={{ animationDelay: '0.4s' }}>
          <p className="text-gray-600 font-serif">
            New to Divine Sweets?{' '}
            <button
